...
public class ImageEffects
			...
			ImageFilter filter = new RGBImageFilter()
				{
					...
					public int filterRGB(int x, int y, int rgb)
						...
						if (ColourDistance(new Color(rgb), new Color(col)) < toleranceSlider.getValue()) return col & 0x00FFFFFF;
						return rgb;
						}
				};
    ...
    public BufferedImage applyBrightnessAndContrast(BufferedImage bi, double brightness, double contrast) {
		...
		public BufferedImage getAppliedImage(BufferedImage img)
			{
				return this.applyBrightnessAndContrast(img,brightnessSlider.getValue(), contrastSlider.getValue());
			}
