...
public class ComboBoxLink<K extends Enum<K>, T> extends PropertyLink<K,Object> implements
		ActionListener
	{
	public final JComboBox<T> box;
	...
	public ComboBoxLink(JComboBox<T> b, PropertyMap<K> m, K k, ComboBoxConversion conv)
		{
		super(m,k);
		box = b;
